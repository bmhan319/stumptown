...
let products = [
  ...
  {id: 20,
   ...
   bgColor: "rgb(81, 44, 29)",
   textColor: "#512c1d",
   description: "You have never tasted a dark roast quite like this. This toasty blend redefines what a dark roast can be – big and smoky, but never burnt.",
   category: "Organic",
   size: "Whole Bean, 12 ounces",
   producer: "The Story",
  ...
  {id: 21,
   ...
   bgColor: "rgb(81, 44, 29)",
   textColor: "#512c1d",
   description: "Finally, a decaf that holds its own. Recent updates to the organic Swiss Water decaf process have allowed for unparalleled flavor and cup quality.",
   category: "Whole Bean",
   size: "12 ounces",
   producer: "The Story",
  ...
  {id: 22,
   ...
   bgColor: "rgb(31, 24, 21)",
   textColor: "#1f1815",
   description: "Make perfect cold brew at home. Seriously caffeinated and super delicious.",
   category: "Takes 12-24 hours",
   size: "Makes 32 oz of concentrate",
   producer: "Syrupy and sweet cup with reduced acidity.",
   producerDescription:"We love the Filtron because it’s easy to use, consistent and makes a big batch of cold brew concentrate. The initial brew takes 12-24 hours, but you’ll be energetically thanking yourself for it later.",
   region: "",
   regionDescription: "",
   listItem1: "Includes coffee / water bowl, rubber stopper, grounds guard, measuring cup, decanter, sample paper liner, wool filter pad",
  ...
  {id: 23,
   ...
   bgColor: "rgb(31, 24, 21)",
   textColor: "#1f1815",
   description: "With its stainless steel and wavy contours, the Kalita Wave wins over coffee and design enthusiasts alike.",
   category: "Stainless Steel Brewer",
   size: "Use with Kalita Wave filters",
   producer: "A staff favorite for home brews and camp coffee",
   producerDescription:"The flat-bottom filter helps with even extraction while brewing an exceptional cup. The key to mastering this brewer is the slow spiral pour – a gooseneck kettle will help you master this method.",
   region: "",
   regionDescription: "",
  ...
  {id: 24,
   ...
   bgColor: "rgb(31, 24, 21)",
   textColor: "#1f1815",
   description: "If you’re boldly going for it, this is your new best friend. You get the most of everything here–big flavor, body, and mouthfeel.",
   category: "Brews 51 oz",
   size: "Replacement Glass Available",
   producer: "Textural and thick with full body and a heavy sweetness",
   producerDescription:"Easy to brew and super consistent, the French Press is really reliable, brewing a textural and heavy-bodied cup in 4 minutes. Its classic and well-engineered design hasn’t changed much since its invention in the ‘50s.",
   region: "",
   regionDescription: "",
   ...
   listItem4: "Stainless steel and mesh filter keeps out grounds and disassembles for cleaning",
   listItem5: "none",
   sideImage1: genImage(),
   sideImage2: "none",
   sideImage3: "none",
